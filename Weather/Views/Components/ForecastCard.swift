...
//  Weather
//
//  Created by Adrián Alpuche on 19/05/23.
//
...
struct ForecastCard: View {
    ...
    var forecastPeriod: ForescastPeriod
    var isActive: Bool {
        if forecastPeriod ==  ForescastPeriod.hourly{
    ...
    var body: some View {
        ZStack{
            ...
            VStack(spacing:10){
                Text(forecast.date, format: forecastPeriod == ForescastPeriod.hourly ? .dateTime.hour(): .dateTime.weekday())
